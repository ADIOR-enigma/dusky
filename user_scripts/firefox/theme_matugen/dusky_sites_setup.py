...
:root {
    ...
    --arrowpanel-border-color: var(--lwt-popup-border-color, var(--toolbar-field-border, rgba(255,255,255,0.15))) !important;
...
#sidebar-header,
sidebarheader {
    background-color: var(--lwt-sidebar-background-color, var(--lwt-accent-color, #1c1b22)) !important;
    color: var(--lwt-sidebar-text-color, var(--lwt-text-color, #fbfbfe)) !important;
}
...
.popup-notification-body {
    ...
    --panel-border-color: var(--lwt-popup-border-color, var(--toolbar-field-border, rgba(255,255,255,0.15))) !important;

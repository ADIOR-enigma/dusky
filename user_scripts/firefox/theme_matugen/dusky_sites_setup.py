...
:root {
    ...
    --arrowpanel-background: var(--lwt-popup-background-color, var(--lwt-accent-color, #1c1b22)) !important;
    --arrowpanel-color: var(--lwt-popup-color, var(--lwt-text-color, #fbfbfe)) !important;
    --arrowpanel-border-color: var(--lwt-popup-border-color, var(--toolbar-field-border-color, rgba(255,255,255,0.15))) !important;
    --panel-item-hover-bgcolor: var(--toolbarbutton-background-color-hover, rgba(255, 255, 255, 0.1)) !important;
    --panel-item-hover-color: var(--lwt-popup-color, var(--lwt-text-color, #fbfbfe)) !important;
    --panel-separator-color: var(--toolbar-field-border-color, rgba(255, 255, 255, 0.15)) !important;
    ...
    --message-bar-icon-color: var(--lwt-popup-color, var(--lwt-text-color, #fbfbfe)) !important;
    --message-bar-border-color: var(--toolbar-field-border-color, rgba(255,255,255,0.15)) !important;
}
...
.popup-notification-body {
    ...
    --panel-color: var(--lwt-popup-color, var(--lwt-text-color, #fbfbfe)) !important;
    --panel-border-color: var(--lwt-popup-border-color, var(--toolbar-field-border-color, rgba(255,255,255,0.15))) !important;
    ...
    --menu-border-color: var(--lwt-popup-border-color, var(--toolbar-field-border-color, rgba(255,255,255,0.15))) !important;
}
...
panel#autoscroller {
    ...
    background: var(--lwt-popup-background-color, var(--lwt-accent-color, #1c1b22)) !important;
    color: var(--lwt-popup-color, var(--lwt-text-color, #fbfbfe)) !important;
    border: 1px solid var(--lwt-popup-border-color, var(--toolbar-field-border-color, rgba(255,255,255,0.2))) !important;
...
menupopup::part(content) {
    ...
    border: 1px solid var(--lwt-popup-border-color, var(--toolbar-field-border-color, var(--lwt-accent-color))) !important;
}
...
menuseparator::before {
    border-top: 1px solid var(--toolbar-field-border-color, rgba(255,255,255,0.15)) !important;
}
...
#pointerlock-warning {
    ...
    background-color: var(--lwt-popup-background-color, var(--lwt-accent-color, #1c1b22)) !important;
    color: var(--lwt-popup-color, var(--lwt-text-color, #fbfbfe)) !important;
    border: 1px solid var(--lwt-popup-border-color, var(--toolbar-field-border-color, rgba(255,255,255,0.15))) !important;
    border-radius: 6px !important;
}
...
notification-message moz-button.close {
    ...
    border: 1px solid var(--toolbar-field-border-color, rgba(255,255,255,0.15)) !important;

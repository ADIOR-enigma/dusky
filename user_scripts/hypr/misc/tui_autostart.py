...
SCHEMA = {
    ...
    1: [
        ...
        ConfigItem(
            ...
            scope="DEFAULT",
            type_="action",
            default="hypr-app wl-paste --type text --watch cliphist store",
        ...
        ConfigItem(
            ...
            scope="DEFAULT",
            type_="action",
            default="hypr-app wl-paste --type image --watch cliphist store",
            parent_ref="menu_clipboard",
            group="Clipboard",
        ...
        ConfigItem(
            ...
            scope="DEFAULT",
            type_="action",
            default="hypr-app sh -c '. $HOME/.config/dusky/settings/cliphist_db_env && exec wl-paste --type text --watch cliphist store'",
            parent_ref="menu_clipboard",
            group="Clipboard",
        ...
        ConfigItem(
            ...
            scope="DEFAULT",
            type_="action",
            default="hypr-app sh -c '. $HOME/.config/dusky/settings/cliphist_db_env && exec wl-paste --type image --watch cliphist store'",
            parent_ref="menu_clipboard",
            group="Clipboard",
        ...
        ConfigItem(
            ...
            scope="DEFAULT",
            type_="action",
            default="hypr-app wl-clip-persist --clipboard regular",
            parent_ref="menu_clipboard",
            group="Clipboard",

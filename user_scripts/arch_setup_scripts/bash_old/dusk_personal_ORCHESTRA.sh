...
#    "U | 020_desktop_apps_username_setter.sh"
    ...
    "U | 130_systemd_dbus_service_manager.py"
...
#    "U | 255_tldr_update.sh"
    ...
    "U | 290_dusky_service_deployer.py"
#    "S | 295_initramfs_optimization.py"
    ...
    "S | 320_systemdboot_optimization.py"
...
#    "S | 335_preload_config.sh"
    ...
    "U | 383_configure_hyprland_gpu.py"
